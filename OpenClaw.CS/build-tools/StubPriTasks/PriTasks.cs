...
namespace Microsoft.Build.Packaging.Pri.Tasks
{
    ...
    public class CreatePriConfigXmlForSplitting : Task
    {
        ...
        public ITaskItem[] QualifierInfo { get; set; }
        public string VsTelemetrySession { get; set; }
    ...
    public class CreatePriFilesForPortableLibraries : Task
    {
        ...
        public string VsTelemetrySession { get; set; }
        [Output] public ITaskItem[] PriFiles { get; set; }
        [Output] public ITaskItem[] IntermediateFileWrites { get; set; }
        [Output] public ITaskItem[] CreatedResWFiles { get; set; }
        [Output] public ITaskItem[] ResourcesWithNoPri { get; set; }
        public override bool Execute() { PriFiles = new ITaskItem[0]; IntermediateFileWrites = new ITaskItem[0]; CreatedResWFiles = new ITaskItem[0]; ResourcesWithNoPri = new ITaskItem[0]; return true; }
    }
    ...
    public class GeneratePriConfigurationFiles : Task
    {
        ...
        public override bool Execute() { GeneratedFiles = new ITaskItem[0]; AdditionalResourceResFiles = new ITaskItem[0]; return true; }
    }
    ...
    public class GenerateProjectPriFile : Task
    {
        ...
        public string MakePriExtensionPath { get; set; }
        public string PriConfigXmlPath { get; set; }
        public ITaskItem[] IndexFilesForQualifiersCollection { get; set; }
        ...
        public string AdditionalMakepriExeParameters { get; set; }
        public string VsTelemetrySession { get; set; }
        [Output] public ITaskItem[] OutputPriFile { get; set; }
        [Output] public ITaskItem[] IntermediateFileWrites { get; set; }
        public override bool Execute() { OutputPriFile = new ITaskItem[0]; IntermediateFileWrites = new ITaskItem[0]; return true; }
    }
